...
function HeroOne() {
  return (
    <div className="w-full h-auto bg-[#005911] py-12">
      <div className="flex flex-col items-center justify-between px-6 space-y-8 lg:flex-row lg:space-y-0 sm:px-12 lg:px-24 xl:px-52">
        ...
        <div className="flex flex-col items-center text-center lg:items-end">
          ...
          <img
            ...
            className="w-48 h-auto lg:w-56 xl:w-64"
          />
        </div>
      </div>
    </div>
